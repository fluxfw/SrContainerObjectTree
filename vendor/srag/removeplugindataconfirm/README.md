...
```php
//...
use srag\RemovePluginDataConfirm\SrCurriculum\x\PluginUninstallTrait;
//...
...
```php
//...
use srag\RemovePluginDataConfirm\SrCurriculum\x\RepositoryObjectPluginUninstallTrait;
//...
