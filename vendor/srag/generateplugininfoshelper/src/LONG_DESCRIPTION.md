...
```php
...
use srag\GeneratePluginInfosHelper\SrContainerObjectTree\x\GeneratePluginPhpAndXml; 
...
...
```php
...
use srag\GeneratePluginInfosHelper\SrContainerObjectTree\x\GeneratePluginReadme; 
...
...
```json
  ...
  "update-version": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrContainerObjectTree\\x\\UpdateVersion::updateVersion"
    ]
  ...
```
...
```php
...
use srag\GeneratePluginInfosHelper\SrContainerObjectTree\x\UpdateVersion; 
...
