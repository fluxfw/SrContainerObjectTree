...
use srag\Plugins\SrCurriculum\Curriculum\Application\CurriculumApplicationService;
...
class ilObjSrCurriculumGUI extends ilObjectPluginGUI
{
    ...
    protected function show(string $html)/* : void*/
    {
        if (!self::dic()->ctrl()->isAsynch()) {
            ...
            if (!$this->object->isOnline() && !ilObjSrCurriculumAccess::hasEditPermissionAccess()) {
    ...
    protected function showContents()/* : void*/
    {
        ...
        $this->show(
            CurriculumApplicationService::new(
                'ilObjSrCurriculumGUI',
                self::CMD_SHOW_CONTENTS,
                $this->object->getStartNodeRefId()
            )->run());
    }
}
