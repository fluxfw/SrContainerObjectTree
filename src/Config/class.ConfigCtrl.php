 ...
 *
 * @ilCtrl_isCalledBy srag\Plugins\SrCurriculum\Config\ConfigCtrl: ilSrCurriculumConfigGUI
 */
class ConfigCtrl
{
    ...
    protected function configure()/* : void*/
    {
        ...
        $form = self::srCurriculum()->config()->factory()->newFormBuilderInstance($this);
