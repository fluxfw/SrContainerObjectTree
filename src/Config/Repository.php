...
final class Repository extends AbstractRepository
{
    ...
    protected function getFields() : array
    {
        return [
            ...
            FormBuilder::KEY_MAX_DEEP_METHOD_START_SHOW_ARROW         => [Config::TYPE_BOOLEAN, false],
            FormBuilder::KEY_MAX_DEEP_METHOD_START_HIDE_METADATA      => [Config::TYPE_BOOLEAN, false],
            ...
            FormBuilder::KEY_USER_SETTINGS_PER_OBJECT                 => [Config::TYPE_BOOLEAN, true]
        ];
    }
